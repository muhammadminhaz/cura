...
public class LocalStack extends Stack {
    ...
    private FargateService createFargateService(String id, String imageName, List<Integer> ports, DatabaseInstance db, Map<String, String> envVars) {
        ...
        envVarsMap.put("SPRING_CACHE_TYPE", "redis");
        envVarsMap.put("SPRING_DATA_REDIS_HOST", elastiCacheCluster.getAttrRedisEndpointAddress());
        envVarsMap.put("SPRING_DATA_REDIS_PORT", elastiCacheCluster.getAttrRedisEndpointPort());
        ...
        ContainerDefinitionOptions containerOptions =
                ContainerDefinitionOptions.builder()
                        ...
                        .environment(Map.of(
                                ...
                                "REDIST_HOST", elastiCacheCluster.getAttrRedisEndpointAddress(),
                                "REDIST_PORT", elastiCacheCluster.getAttrRedisEndpointPort()
                        ))
